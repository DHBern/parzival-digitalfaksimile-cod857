...
function showSlide() {
	...
	if (curSlide=="291_1") {zweiInitialen="1. "}
	if (curSlide=="291_2") {zweiInitialen="2. "}
	if (curSlide !="291_1" && curSlide!="291_2") {zweiInitialen="";}
...
if (curSlide=="291_1") {
window.location.href="InitParzival.html?276&" + standardAnsicht;
}
...
window.location.href = "../nibelungen.html?" + parseInt(curSlide) + "&100";
}
