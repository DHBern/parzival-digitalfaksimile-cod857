...
function setListeners() {
	...
	infoButton.addEventListener("click", function() {
  		infoFenster('info/infoKlage.html');
	});
	...
	versSelect = document.getElementById("versSelect");
	versSelect.addEventListener("change", MM_jumpMenuParts);
...
function zoom150() {
		...
		if (curSlide<=416 && zoom==50) {window.location.href="nibelungen.html?415&150";}		
...
function zoom100() {
		...
		if (curSlide<=416 && zoom==50) {window.location.href="nibelungen.html?415&100";}		
		if(zoom==50) {seiteAnpassen();}
		zoom = 100;
		showSlide();	
}
...
function checkSeiteUp() {
		...
		if ((curSlide==453 || curSlide==454) && zoom==50) {
		window.location.href="karl.html?451";
		curSlide=451;
		}
...
function checkSeiteDown() {
		...
		if (curSlide==413 && zoom==50) {
		window.location.href="nibelungen.html?415";
		curSlide=415;
		}
		
		if (curSlide==415 && zoom!=50) {
		window.location.href="nibelungen.html?416" + "&" + zoom;
		}
